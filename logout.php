...
<html lang="en">
  ...
  <body>
    ...
    <div class="container my-5">
        ...
        <p>You are about to logged Out. You have to logged in for Continue on Website</p>
        <p class="mb-0">You have to Signup for new account and have to login in any of account using Name and Password</p>
        <hr>
        <p class="mb-0">Click on logout button to logout and have to login again for access.</p>
